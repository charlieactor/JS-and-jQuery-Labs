...
/************************* Your Solution *************************/
  ...
  for (var state in states) {
    var statesLat = states[state].lat;
    var statesLong = states[state].long;
    if (statesLat >= minLat && statesLat <= maxLat) {
      if (statesLong >= minLong && statesLong <= maxLong) {
...
/************************* Your Solution *************************/
  var result = {};
  ips.forEach(function(value, idx, array) {
...
/************************* Your Solution *************************/
  var result = {};
  result.committer = commit.committer.name;
  result.timestamp = commit.committer.date;
